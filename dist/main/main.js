...
Object.defineProperty(exports, "__esModule", { value: true });
exports.events = {
    close: 'ElectronShortcutCapture::CLOSE',
    download: 'ElectronShortcutCapture::DOWNLOAD',
    clipboard: 'ElectronShortcutCapture::CLIPBOARD',
    setCapturingDisplayId: 'ElectronShortcutCapture::SETCAPTURINGDISPLAYID',
    receiveCapturingDisplayId: 'ElectronShortcutCapture::RECEIVECAPTURINGDISPLAYID'
};
...
exports.default = browserWindowProps;


/***/ }),

/***/ "./src/main/electron-shortcut-capture.ts":
/*!***********************************************!*\
  !*** ./src/main/electron-shortcut-capture.ts ***!
  \***********************************************/
/*! no static exports found */
...
var electronShortcutCapture = /** @class */ (function () {
    function electronShortcutCapture(props) {
        // 显示器数组
        this.captureWins = [];
        // 允许多屏幕
    ...
    electronShortcutCapture.prototype.initWin = function () {
        ...
        if (!this.multiScreen) {
            ...
            var display = electron_1.screen.getDisplayNearestPoint(mousePoint);
            displays = [display];
        }
        else {
            // 获取设备所有显示器
        ...
        this.captureWins = displays.map(function (display) {
            var captureWin = new electron_1.BrowserWindow(browserWindowProps_1.default(display));
            return captureWin;
        });
    ...
    electronShortcutCapture.prototype.bindDownload = function () {
        ...
        electron_1.ipcMain.on(constant_1.events.download, function (_, _a) {
            ...
            try {
                __webpack_require__(/*! fs */ "fs").writeFileSync(path, dataBuffer);
            }
            catch (err) {
    ...
    electronShortcutCapture.prototype.listenCapturingDisplayId = function () {
        ...
        electron_1.ipcMain.on(constant_1.events.setCapturingDisplayId, function (_, displayId) {
            _this.captureWins.map(function (v) {
                v.webContents.send(constant_1.events.receiveCapturingDisplayId, displayId);
            });
        });
    };
...
Object.defineProperty(exports, "__esModule", { value: true });
var electron_1 = __webpack_require__(/*! electron */ "electron");
var electron_shortcut_capture_1 = __webpack_require__(/*! ./electron-shortcut-capture */ "./src/main/electron-shortcut-capture.ts");
electron_1.app.on('ready', function () {
    __webpack_require__(/*! electron-debug */ "./node_modules/electron-debug/index.js")({ devToolsMode: 'right', showDevTools: false });
    electron_1.globalShortcut.register('alt+shift+w', function () {
        new electron_shortcut_capture_1.default({
            multiScreen: true
        }).show();
    });
});
